---
title: "قالب فاکتور پاکت"
description: "راهنمای قالب فاکتور پاکت"
---
...
بعد از آپلود قالب وارد ناحیه ادمین خود شوید. به مسیر `System Setting/Addon Modules` شوید
![pocketinvoice](../../static/img/pocket_1.png)
![pocketinvoice](../../static/img/pocket_2.png)

ماژول قالب را فعال و دسترسی لازم را به آن دهید
![pocketinvoice](../../static/img/pocket_3.png)
![pocketinvoice](../../static/img/pocket_4.png)

در منوی بالا وارد پنل ماژول شوید\
![pocketinvoice](../../static/img/pocket_5.png)

## شخصی سازی قالب فاکتور

در سیستم whmcs دو نوع فاکتور موجود است. آنلاین و pdf. در قالب 2 دموی آنلاین و یک دموی pdf موجود است که در نسخه های بعد دموهای بیشتری اضافه میشود.
...
![pocketinvoice](../../static/img/pocket_9.png)
در قالب 4 فونت موجود است نام یکی از آنها را به دلخواه وارد کنید

- `dana`: دانا
- `iranyekanxfanum`: ایران یکان
- `iransansxfanum`: ایران سنس
- `yekanbakhfanumb`: یکان بخ

برای شخصی سازی قالب و همچنین اضافه کردن فونت و رنگ جدید از طریق [تیکت](https://www.rtl-theme.com/dashboard/#/ticket-send) در ارتباط باشید.\
