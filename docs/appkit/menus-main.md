...
با توجه به اینکه اپکیت یک قالب HTML است، ویرایش کل منو به معنای ویرایش هر صفحه HTML جداگانه است که برای پروژه های بزرگ میتواند بسیار خسته کننده باشد. به همین دلیل، قالب از منوهای خارجی(external) استفاده میکند که ویرایش آن را بسیار ساده تر میکند. شما فقط باید یک فایل HTML را ویرایش کنید.\
بیایید توضیح دهیم:
