...
هنگام ایجاد رنگ برای قالب، اپکیت انعطاف پذیری بینظیری دارد و به شما این امکان را میدهد که به راحتی هر طرح رنگی را که میخواهید به آسانی ایجاد کنید. بنابراین، استفاده از SCSS بهترین راه حل برای اطمینان از یک طرح رنگی سریع، آسان و در عین حال ایجاد طرح های رنگی جدید فوق العاده آسان است.\
...
**highlight_red.css** را با رنگ‌های موجود در پوشه styles/highlights جایگزین کنید. لطفاً مرحله زیر را بخوانید تا درک کنید اپکیت چگونه طرح رنگ صحیح را بارگذاری میکنند. استفاده از آن واقعاً ساده است.
