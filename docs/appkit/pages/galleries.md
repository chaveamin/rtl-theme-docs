...
<div class="card card-style">
    <div class="content mb-3">
        <div class="gallery gallery-filter">
            <a href="images/pictures/9t.jpg" data-lightbox="gal" class="filtr-item" description="Text" data-category="1">
                <img src="images/empty.png" data-src="images/pictures/9s.jpg" class="preload-img rounded-s shadow-m" alt="image">
            </a>
            <a href="images/pictures/14t.jpg" data-lightbox="gal" class="filtr-item" description="Text" data-category="2">
                <img src="images/empty.png" data-src="images/pictures/14s.jpg" class="preload-img rounded-s shadow-m" alt="image">
            </a>
            <a href="images/pictures/18t.jpg" data-lightbox="gal" class="filtr-item" description="Text" data-category="3">
